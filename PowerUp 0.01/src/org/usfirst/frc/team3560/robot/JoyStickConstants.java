...
public class JoyStickConstants
{
	...
	public static final int JOY_ANALOG_Z = 2;
	public static final int JOY_ANALOG_SLIDER = 3;

	public static final int JOY_POV_X = 4;
	public static final int JOY_POV_Y = 5;
	// END OF JOYSTICK
